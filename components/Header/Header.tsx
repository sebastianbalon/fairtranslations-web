            ...
            {props.language === 'cs' ? (
              ...
              <>
                ...
                <NavbarDropdown title="Inne usługi">
                  <NavbarLink href="/pl/posrednictwo-w-rozmowach-telefonicznych">Pośrednictwo w rozmowach
                    telefonicznych</NavbarLink>
                  <NavbarLink href="/pl/wsparcie-dla-osob-prowadzacych-dzialalnosc">Wsparcie dla osób prowadzących
                    działalność</NavbarLink>
                </NavbarDropdown>
